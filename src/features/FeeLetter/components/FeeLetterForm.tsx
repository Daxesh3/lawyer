      ...
      <form className="space-y-6">
        ...
        <div>
          <label htmlFor="governingLaw" className="block text-sm font-medium text-gray-700 mb-1">
            Q.14 Should a standalone Gross Up provision be included or should cross reference be made to the Facility
            Agreement?
          </label>
          <input
            type="text"
        ...
        <div>
          <label htmlFor="governingLaw" className="block text-sm font-medium text-gray-700 mb-1">
            Q.15 Should a standalone VAT provision be included or should cross reference be made to the Facility
            Agreement?
          </label>
          <input
            type="text"
        ...
        <div>
          <label htmlFor="governingLaw" className="block text-sm font-medium text-gray-700 mb-1">
            Q.17 Should a standalone Jurisdiction provision be included or should cross reference be made to the
            Facility Agreement?
          </label>
          <input
            type="text"

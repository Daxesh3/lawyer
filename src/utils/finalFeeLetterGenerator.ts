...
export const finalGenerateFeeLetterText = (data: IFeeLetterData) => {
  let output: string = '';
  ...
  // Introduction
  output += `<div style="display: flex; margin-left: 2em; margin-bottom: 1em;"><p >1. </p>We refer to the Facility Agreement.</div>\n`;
  output += `<div style="display: flex; margin-left: 2em; margin-bottom: 1em;"><p >2. </p>Unless otherwise defined in this Fee Letter, terms defined in the Facility Agreement shall have the same meaning in this Fee Letter. The rules of interpretation and construction contained in clause *{[1.2] (Construction)}* of the Facility Agreement shall apply to this Fee Letter as if set out in full in this Fee Letter mutatis mutandis, and references in those clauses to "this Agreement" or the *{Finance Documents}* shall be construed as references to this Fee Letter.</div>\n`;

  // Specific introduction based on letter type
  switch (data.letterType) {
    case 'facilityAgent':
      output += `<div style="display: flex; margin-left: 2em; margin-bottom: 1em;"><p >3. </p>This Letter is the Facility Agent Fee Letter.</div>\n`;
      break;
    case 'securityAgent':
      output += `<div style="display: flex; margin-left: 2em; margin-bottom: 1em;"><p >3. </p>This Letter is the Security Agent Fee Letter.</div>\n`;
      break;
    case 'globalCoordinator':
      output += `<div style="display: flex; margin-left: 2em; margin-bottom: 1em;"><p >3. </p>This Letter is the Global Co-Ordinator Fee Letter.</div>\n`;
      break;
    case 'coordinatingBank':
      output += `<div style="display: flex; margin-left: 2em; margin-bottom: 1em;"><p >3. </p>This Letter is the Co-Ordinating Bank Fee Letter.</div>\n`;
      break;
    case 'upfront':
      output += `<div style="display: flex; margin-left: 2em; margin-bottom: 1em;"><p >3. </p>This Letter is the Upfront Fee Letter.</div>\n`;
      break;
    case 'mandatedLeadArranger':
      output += `<div style="display: flex; margin-left: 2em; margin-bottom: 1em;"><p >3. </p>This Letter is the Mandated Lead Arranger Fee Letter.</div>\n`;
      break;
    case 'arranger':
      output += `<div style="display: flex; margin-left: 2em; margin-bottom: 1em;"><p >3. </p>This Letter is the Arranger Fee Letter.</div>\n`;
      break;
    default:
      output += `<div style="display: flex; margin-left: 2em; margin-bottom: 1em;"><p >3. </p>This Letter is the Facility Agent Fee Letter.</div>\n`;
  }
  ...
  output += `<div style="display: flex; margin-left: 2em; margin-bottom: 1em;"><p >4. </p>This ${getLetterTitle()
    .replace(/\(|\)/g, '')
    .toLowerCase()
    .split(' ')
    .map((word) => word.charAt(0).toUpperCase() + word.slice(1))
    .join(' ')} is a *{Finance Documents}* for the purposes of the Facility Agreement.</div>\n`;

  // Fees section based on letter type
  switch (data.letterType) {
    case 'facilityAgent':
      if (data.hasFacilityAgentOptions) {
        output += `<div style="display: flex; margin-left: 2em; margin-bottom: 1em;"><p >5. </p>You shall pay to the Facility Agent (for its own account):</div>\n`;

        if (data.setupFeeAmount) {
          output += `<div style="display: flex; margin-left: 2em; margin-bottom: 1em;"><p class='indent'>(a) </pclass=><p>a one-off set-up fee in an amount of ${data.currency} ${data.setupFeeAmount} (the <b>"Set-Up Fee"</b>),</p></div>\n`;
        }

        output += `<div style="display: flex; margin-left: 2em; margin-bottom: 1em;"><p class='indent'>(b) </pclass=><p>a fee of ${data.currency} ${data.facilityAgentFeeAmount} per annum, which is payable in advance, for the Facility Agent acting as facility agent pursuant to the provisions of the Facility Agreement (the <b>"Facility Agent Fee"</b>),</p></div>\n`;

        if (data.increaseFeeAmount) {
          output += `<div style="display: flex; margin-left: 2em; margin-bottom: 1em;"><p class='indent'>(c) </pclass=><p>a fee of ${data.currency} ${data.increaseFeeAmount} if the Borrower exercises the Increase Option more than ${data.increaseCount} times (the "Increase Fee"), and</p></div>\n`;
        }
        ...
        output += `<div style="display: flex; margin-left: 2em; margin-bottom: 1em;"><p class='indent'>(e) </pclass=><p>The Set-Up Fee, Facility Agent Fee, Increase Fee and Debtdomain Fee shall hereinafter be referred to as the <b>"Agency Fees"</b>.</p></div>\n`;
      } else {
        output += `<div style="display: flex; margin-left: 2em; margin-bottom: 1em;"><p class='indent'>Only one type: facility agent pursuant to the provisions of the Facility Agreement (the <b>"Facility Agent Fee"</b>).</pclass=></div>\n`;
      }
      break;

    case 'securityAgent':
      output += `<div style="display: flex; margin-left: 2em; margin-bottom: 1em;"><p >5. </p><p>You shall pay to the Security Agent (for its own account) a fee of ${data.currency} ${data.securityAgentFeeAmount} per annum, which is payable in advance, for the Security Agent acting as security agent pursuant to the provisions of the Facility Agreement (the <b>"Security Agent Fee"</b>).</p></div>\n`;
      break;

    case 'globalCoordinator':
      output += `<div style="display: flex; margin-left: 2em; margin-bottom: 1em;"><p >5. </p><p>You shall pay to the Global Co-Ordinator (for its own account) a flat fee of ${data.currency} ${data.globalCoordinatorFeeAmount} for the Global Co-Ordinator acting as global co-ordinator pursuant to the provisions of the Facility Agreement (the <b>"Global Co-Ordinator Bank Fee"</b>).</p></div>\n`;
      break;

    case 'coordinatingBank':
      output += `<div style="display: flex; margin-left: 2em; margin-bottom: 1em;"><p >5. </p><p>You shall pay to the Co-Ordinating Bank (for its own account) a flat fee of ${data.currency} ${data.coordinatingBankFeeAmount} for the CoOrdinating Bank acting as co-ordinating bank pursuant to the provisions of the Facility Agreement (the <b>"Coordinating Bank Fee"</b>).</p></div>\n`;
      break;

    case 'upfront':
      output += `<div style="display: flex; margin-left: 2em; margin-bottom: 1em;"><p >5. </p>You shall pay to the Facility Agent (for the account of the *{Original Lenders}*) a fee of ${data.currency} ${data.upfrontFeeAmount} for the *{Original Lenders}* extending their Commitments to the Borrower under the Facility Agreement (an "Upfront Fee"). Each *{Original Lender}* shall be entitled to its pro rata share of the Upfront Fee. Its pro rata share shall be equal to the proportion its Commitment bears to the Total Commitment.</div>\n`;
      break;

    case 'mandatedLeadArranger':
      output += `<div style="display: flex; margin-left: 2em; margin-bottom: 1em;"><p >5. </p>You shall pay to the Facility Agent (for the account of the *{Mandated Lead Arrangers}*) a fee of ${data.currency} ${data.mandatedLeadArrangerFeeAmount} for the *{Mandated Lead Arrangers}* under the Facility Agreement (an "Mandated Lead Arranger Fee"). Each *{Mandated Lead Arranger}* shall be entitled to its pro rata share of the Mandated Lead Arranger Fee. Its pro rata share shall be equal to the proportion its Commitment bears to the Total Commitment of all the *{Mandated Lead Arrangers}*</div>\n`;
      break;

    case 'arranger':
      output += `<div style="display: flex; margin-left: 2em; margin-bottom: 1em;"><p >5. </p><p>You shall pay to the Facility Agent (for the account of the *{Arrangers}*) a fee of ${data.currency} ${data.arrangerFeeAmount} for the *{Arrangers}* under the Facility Agreement (an <b>"Arranger Fee"</b>). Each *{Arranger}* shall be entitled to its pro rata share of the Arranger Fee. Its pro rata share shall be equal to the proportion its Commitment bears to the Total Commitment of all the *{Arrangers}*</p></div>\n`;
      break;
  ...
  switch (data.letterType) {
    case 'facilityAgent':
      if (data.hasFacilityAgentOptions) {
        output += `<div style="display: flex; margin-left: 2em; margin-bottom: 1em;">Payment Modalities Facility Agent (More than one type)\n\n6. The Agency Fees shall become due and payable as set out below.</div>\n`;
        ...
        if (data.paymentModality === 'annual') {
          output += `<div style="display: flex; flex-direction:column"><div style="display: flex; margin-left: 2em; margin-bottom: 1em;"><p class='indent'>(b) </pclass=><p>The first payment of the Facility Agent Fee is payable on or before [the earlier to occur of the date falling {[${data.businessDays}]} *{Business Days}* after the date of the Facility Agreement and the first *{Utilisation Date}* under the Facility Agreement (the "FirstPayment Date")][the First Payment Date]. Each subsequent payment of the Facility Agent Fee shall be made annually in advance, commencing on the first anniversary of the First Payment Date and thereafter on each subsequent anniversary of the First Payment Date, until (but excluding) the earlier of</p></div>
        
       <div style="display: flex; margin-left: 2em; margin-bottom: 1em;"><p style=" margin-left: 4em; margin-top: 0.5em; ">(i)</p><p>the *{Final Maturity Date}*,</p></div>
        <div style="display: flex; margin-left: 2em; margin-bottom: 1em;"><p style=" margin-left: 4em; margin-top: 0.5em; ">(ii)</p><p>the date we resign or are replaced as facility agent and</p></div>
        <div style="display: flex; margin-left: 2em; margin-bottom: 1em;"><p style=" margin-left: 4em; margin-top: 0.5em; ">(iii)</p><p>the date of prepayment of all *{Loans}* and cancellation - of all *{Commitments}*, in each case under the Facility Agreement (the <b>"Final Payment Date"</b>).</p></div></div>\n`;
        ...
        <div style="display: flex; margin-left: 2em; margin-bottom: 1em;"><p style=" margin-left: 4em; margin-top: 0.5em; ">(i)</p><p>the *{Final Maturity Date}*,</p></div> 
        <div style="display: flex; margin-left: 2em; margin-bottom: 1em;"><p style=" margin-left: 4em; margin-top: 0.5em; ">(ii)</p><p>the date we resign or are replaced as agent and</p></div> 
        <div style="display: flex; margin-left: 2em; margin-bottom: 1em;"><p style=" margin-left: 4em; margin-top: 0.5em; ">(iii)</p><p>the date of prepayment of all Loans and cancellation of all Commitments, in each case under the Facility Agreement (the <b>"Final Payment Date"</b>).</p></div></div>\n`;
    ...
    case 'securityAgent':
      ...
      if (data.paymentModality === 'annual') {
        output += `<div style="display: flex; flex-direction:column"><div style="display: flex; margin-left: 2em; margin-bottom: 1em;"><p >6.</p><p>The first payment of the Security Agent Fee is payable on or before the earlier to occur of the date falling {[${data.businessDays}]} *{Business Days}* after the date of the Facility Agreement and the first *{Utilisation Date}* under the Facility Agreement (the "First Payment Date"). Each subsequent payment of the Security Agent Fee shall be made annually in advance, commencing on the fist anniversary of the First Payment Date and thereafter on each subsequent anniversary of the First Payment Date, until (but excluding) the earlier of</p></div>
        
        <div style="display: flex; margin-left: 2em; margin-bottom: 1em;"><p style=" margin-left: 4em; margin-top: 0.5em; ">(i)</p><p>the *{Final Maturity Date}*,</p></div>
        <div style="display: flex; margin-left: 2em; margin-bottom: 1em;"><p style=" margin-left: 4em; margin-top: 0.5em; ">(ii)</p><p>the date we resign or are replaced as facility agent and</p></div>
        <div style="display: flex; margin-left: 2em; margin-bottom: 1em;"><p style=" margin-left: 4em; margin-top: 0.5em; ">(iii)</p><p>the date of prepayment of all *{Loans}* and cancellation of all *{Commitments}*, in each case under the Facility Agreement.</p></div></div>`;
      } else if (data.paymentModality === 'semiannual') {
        output += `<div style="display: flex; flex-direction:column"><div style="display: flex; margin-left: 2em; margin-bottom: 1em;"><p >6.</p><p>The Security Agent Fee shall be payable to us in equal semi-annual instalments. Each installment shall amount to half of the annual Security Agent Fee. The first installment of the Security Agent Fee is payable on or before the earlier to occur of the date falling {[${data.businessDays}]} *{Business Days}* after the date of the Facility Agreement and the first *{Utilisation Date}* under the Facility Agreement (the "First Payment Date"). Thereafter any subsequent installment of the Security Agent Fee shall be made to us on the dates falling at intervals of six (6) months until (but excluding) the earlier of</p></div>
    ...
    case 'globalCoordinator':
      output += `Payment Modalities Global Co-Ordinating Bank\n:<div style="display: flex; margin-left: 2em; margin-bottom: 1em;"><p >6.</p>The Global Co-ordinator Fee is payable on or before the earlier to occur of the date falling {[${data.businessDays}]} *{Business Days}* after the date of the Facility Agreement and the first *{Utilisation Date}* under the Facility Agreement.</div>`;
      break;

    case 'coordinatingBank':
      output += `Payment Modalities Co-Ordinating Bank\n:<div style="display: flex; margin-left: 2em; margin-bottom: 1em;"><p >6.</p>The Co-ordinating Bank Fee is payable on or before the earlier to occur of the date falling {[${data.businessDays}]} *{Business Days}* after the date of the Facility Agreement and the first *{Utilisation Date}* under the Facility Agreement.</div>`;
      break;

    case 'upfront':
      output += `Payment Modalities Upfront\n:<div style="display: flex; margin-left: 2em; margin-bottom: 1em;"><p >6.</p>The Upfront Fee is payable on or before the earlier to occur of the date falling {[${data.businessDays}]} *{Business Days}* after the date of the Facility Agreement and the first *{Utilisation Date}* under the Facility Agreement.</div>`;
      break;

    case 'mandatedLeadArranger':
      output += `Payment Modalities Mandate Lead Arranger\n:<div style="display: flex; margin-left: 2em; margin-bottom: 1em;"><p >6.</p>The Mandated Lead Arranger Fee is payable on or before the earlier to occur of the date falling {[${data.businessDays}]} *{Business Days}* after the date of the Facility Agreement and the first *{Utilisation Date}* under the Facility Agreement.</div>`;
      break;

    case 'arranger':
      output += `Payment Modalities Arranger\n:<div style="display: flex; margin-left: 2em; margin-bottom: 1em;"><p >6.</p>The Arranger Fee is payable on or before the earlier to occur of the date falling {[${data.businessDays}]} *{Business Days}* after the date of the Facility Agreement and the first *{Utilisation Date}* under the Facility Agreement.</div>`;
      break;
  ...
  if (data.bankDetails.accountBank || data.bankDetails.accountNumber) {
    output += `<div class='flex flex-col'><div style="display: flex; margin-left: 2em; margin-bottom: 1em;"><p>7.</p>All payments made by you under this Fee Letter must be made in immediately available, freely transferable and cleared funds by crediting the following bank account</p></div>
    ...
    output += `<div style="display: flex; margin-left: 2em; margin-bottom: 1em;"><p >7.</p>A11 payments made by you under this Fee Letter must be made in immediately available, freely transferable and cleared funds by crediting our account (the details of which we have provided you with separately) or such other account as we may notify you in writing with {[${data.businessDays}]} *{Business Days'}*' prior notice.</div>\n`;
  }
  ...
  if (data.grossUpProvision === 'Standalone') {
    output += `<div style="display: flex; margin-left: 2em; margin-bottom: 1em;"><p >8.</p>If any *{Tax}* or amount in respect of a *{Tax}* must be deducted or withheld from any amount payable or paid by the ${data.borrowerName} on account of or by reference to any payment by or obligation of the ${data.borrowerName} hereunder, the ${data.borrowerName} shall pay such additional amounts as may be necessary to ensure that the recipient of such payment receives a net amount equal to the full amount which we would have received from the ${data.borrowerName} had such *{Tax}* not been made.</div>\n`;
  } else {
    output += `<div style="display: flex; margin-left: 2em; margin-bottom: 1em;"><p >8.</p>Clause *{ {12} (Tax Gross Up and Indemnities)}* of the Facility Agreement shall apply to this letter as if set out in full in this letter, mutatis mutandis, and references in that clause to Finance Documents shall be construed as including this Fee Letter.</div>\n`;
  }

  //For VAT Provision
  if (data.vatProvision === 'Standalone') {
    output += `<div style="display: flex; margin-left: 2em; margin-bottom: 1em;"><p >9.</p><p>All payments in connection with this Fee Letter are exclusive of any value added tax or similar charge ("<b>VAT</b>"). If VAT is chargeable, the ${data.borrowerName} shall also and at the same time pay to the recipient of the relevant payment an amount equal to the amount of the VAT.</p></div>\n`;
  } else {
    output += `<div style="display: flex; margin-left: 2em; margin-bottom: 1em;"><p >9.</p>Clause *{ {¢} (VAT)}* of the Facility Agreement shall apply to this letter as if set out in full in this letter, mutatis mutandis, and references in that clause to Finance Documents shall be construed as including this Fee Letter.</div>\n`;
  }

  // Fee refunds - only for facility agent and security agent
  if (data.letterType === 'facilityAgent' || data.letterType === 'securityAgent') {
    output += `<div style="display: flex; margin-left: 2em; margin-bottom: 1em;"><p >10.</p>The ${
      data.letterType === 'facilityAgent' ? 'Agency' : 'Security Agent'
    } Fees once paid are non-refundable (in whole or in part) and non-creditable (in whole or in part) against other fees in connection with the Facility Agreement</div>\n`;
  }

  // Miscellaneous
  output += `<div style="display: flex; margin-left: 2em; margin-bottom: 1em;"><p >11.</p>This Fee Letter and your rights hereunder may not be assigned by you without our prior written consent.</div>\n`;
  ...
  output += `<div style="display: flex; margin-left: 2em; margin-bottom: 1em;"><p >12.</p>This ${agentName} Fee Letter may not be amended or waived except as may be agreed in writing by the ${agentName} and the Borrower.</div>\n`;
  output += `<div style="display: flex; margin-left: 2em; margin-bottom: 1em;"><p >13.</p>This ${agentName} Fee Letter may be signed in any number of counterparts. This has the same effect as if the signatures on the counterparts were on a single copy of this Fee Letter.</div>\n`;
  output += `<div style="display: flex; margin-left: 2em; margin-bottom: 1em;"><p >14.</p>A person who is not a party to this Fee Letter shall have no rights under the Contracts (Rights of Third Parties) Act 1999 or otherwise to enforce or enjoy the benefit of any terms of this Fee Letter.</div>\n`;
  output += `<div style="display: flex; margin-left: 2em; margin-bottom: 1em;"><p >15.</p>This letter and all non-contractual obligations arising from or connected with it are governed by ${data.governingLaw} law.</div>\n`;

  //For Jurisdiction Provision
  if (data.jurisdictionProvision === 'Standalone') {
    output += `<div style="display: flex; margin-left: 2em; margin-bottom: 1em;"><p >16.</p>Each party hereby submits to exclusive jurisdiction of the ${data.governingLaw} courts and waives any defence of forum non conveniens which may be available.</div>\n`;
  } else {
    output += `<div style="display: flex; margin-left: 2em; margin-bottom: 1em;"><p >16.</p>Clause {¢} (Enforcement) of the Facility Agreement shall apply to this Fee Letter as if set out in full in this Fee Letter mutatis mutandis, and references in those clauses to "this Agreement" or the Finance Documents shall be construed as references to this Fee Letter.</div>\n`;
  }

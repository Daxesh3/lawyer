...
export const generateFeeLetterText = (data: IFeeLetterData) => {
  ...
  // Introduction
  output += `<div class='flex ml-6'><p class='w-5 mr-2'>1. </p>We refer to the Facility Agreement.</div>\n`;
  output += `<div class='flex ml-6'><p class='w-5 mr-2'>2. </p>Unless otherwise defined in this Fee Letter, terms defined in the Facility Agreement shall have the same meaning in this Fee Letter. The rules of interpretation and construction contained in clause *{[1.2] (Construction)}* of the Facility Agreement shall apply to this Fee Letter as if set out in full in this Fee Letter mutatis mutandis, and references in those clauses to "this Agreement" or the *{Finance Documents}* shall be construed as references to this Fee Letter.</div>\n`;

  // Specific introduction based on letter type
  switch (data.letterType) {
    case 'facilityAgent':
      output += `<div class='flex ml-6'><p class='w-5 mr-2'>3. </p>This Letter is the Facility Agent Fee Letter.</div>\n`;
      break;
    case 'securityAgent':
      output += `<div class='flex ml-6'><p class='w-5 mr-2'>3. </p>This Letter is the Security Agent Fee Letter.</div>\n`;
      break;
    case 'globalCoordinator':
      output += `<div class='flex ml-6'><p class='w-5 mr-2'>3. </p>This Letter is the Global Co-Ordinator Fee Letter.</div>\n`;
      break;
    case 'coordinatingBank':
      output += `<div class='flex ml-6'><p class='w-5 mr-2'>3. </p>This Letter is the Co-Ordinating Bank Fee Letter.</div>\n`;
      break;
    case 'upfront':
      output += `<div class='flex ml-6'><p class='w-5 mr-2'>3. </p>This Letter is the Upfront Fee Letter.</div>\n`;
      break;
    case 'mandatedLeadArranger':
      output += `<div class='flex ml-6'><p class='w-5 mr-2'>3. </p>This Letter is the Mandated Lead Arranger Fee Letter.</div>\n`;
      break;
    case 'arranger':
      output += `<div class='flex ml-6'><p class='w-5 mr-2'>3. </p>This Letter is the Arranger Fee Letter.</div>\n`;
      break;
    default:
      output += `<div class='flex ml-6'><p class='w-5 mr-2'>3. </p>This Letter is the Facility Agent Fee Letter.</div>\n`;
  }
  ...
  output += `<div class='flex ml-6'><p class='w-5 mr-2'>4. </p>This ${getLetterTitle()
    .replace(/\(|\)/g, '')
    .toLowerCase()
    .split(' ')
  ...
  switch (data.letterType) {
    case 'facilityAgent':
      if (data.hasFacilityAgentOptions) {
        output += `<div class='flex ml-6'><p class='w-5 mr-2'>5. </p>You shall pay to the Facility Agent (for its own account):</div>\n`;
        ...
        output += `<div class='flex ml-6'><p class='ml-8 mr-2'>Only one type: facility agent pursuant to the provisions of the Facility Agreement (the <b>"Facility Agent Fee"</b>).</p></div>\n`;
      }
      break;

    case 'securityAgent':
      output += `<div class='flex ml-6'><p class='w-5 mr-2'>5. </p><p>You shall pay to the Security Agent (for its own account) a fee of ${data.currency} ${data.securityAgentFeeAmount} per annum, which is payable in advance, for the Security Agent acting as security agent pursuant to the provisions of the Facility Agreement (the <b>"Security Agent Fee"</b>).</p></div>\n`;
      break;

    case 'globalCoordinator':
      output += `<div class='flex ml-6'><p class='w-5 mr-2'>5. </p><p>You shall pay to the Global Co-Ordinator (for its own account) a flat fee of ${data.currency} ${data.globalCoordinatorFeeAmount} for the Global Co-Ordinator acting as global co-ordinator pursuant to the provisions of the Facility Agreement (the <b>"Global Co-Ordinator Bank Fee"</b>).</p></div>\n`;
      break;
  ...
  switch (data.letterType) {
    case 'facilityAgent':
      if (data.hasFacilityAgentOptions) {
        output += `<div class='flex ml-6'>Payment Modalities Facility Agent (More than one type)\n\n6. The Agency Fees shall become due and payable as set out below.</div>\n`;
        ...
        output += `<div class='flex ml-6'><p class='ml-8 mr-2'>(d) </p><p>The first payment of the Debtdomain Fee is payable on or before the First Payment Date. Each subsequent payment of the Debtdomain Fee shall be made annually in advance, commencing on the first anniversary of the First Payment Date and thereafter on each subsequent anniversary of the First Payment Date, until the Final Payment Date.</p></div>\n`;
      }
      break;
    ...
    case 'globalCoordinator':
      output += `Payment Modalities Global Co-Ordinating Bank\n:<div class='flex ml-6'><p class='w-5 mr-2'>6.</p>The Global Co-ordinator Fee is payable on or before the earlier to occur of the date falling {[${data.businessDays}]} *{Business Days}* after the date of the Facility Agreement and the first *{Utilisation Date}* under the Facility Agreement.</div>`;
      break;

    case 'coordinatingBank':
      output += `Payment Modalities Co-Ordinating Bank\n:<div class='flex ml-6'><p class='w-5 mr-2'>6.</p>The Co-ordinating Bank Fee is payable on or before the earlier to occur of the date falling {[${data.businessDays}]} *{Business Days}* after the date of the Facility Agreement and the first *{Utilisation Date}* under the Facility Agreement.</div>`;
      break;

    case 'upfront':
      output += `Payment Modalities Upfront\n:<div class='flex ml-6'><p class='w-5 mr-2'>6.</p>The Upfront Fee is payable on or before the earlier to occur of the date falling {[${data.businessDays}]} *{Business Days}* after the date of the Facility Agreement and the first *{Utilisation Date}* under the Facility Agreement.</div>`;
      break;

    case 'mandatedLeadArranger':
      output += `Payment Modalities Mandate Lead Arranger\n:<div class='flex ml-6'><p class='w-5 mr-2'>6.</p>The Mandated Lead Arranger Fee is payable on or before the earlier to occur of the date falling {[${data.businessDays}]} *{Business Days}* after the date of the Facility Agreement and the first *{Utilisation Date}* under the Facility Agreement.</div>`;
      break;

    case 'arranger':
      output += `Payment Modalities Arranger\n:<div class='flex ml-6'><p class='w-5 mr-2'>6.</p>The Arranger Fee is payable on or before the earlier to occur of the date falling {[${data.businessDays}]} *{Business Days}* after the date of the Facility Agreement and the first *{Utilisation Date}* under the Facility Agreement.</div>`;
      break;
  ...
  if (data.bankDetails.accountBank || data.bankDetails.accountNumber) {
    output += `<div class='flex flex-col ml-6'><div class='flex'><p class='w-5 mr-2'>7.</p>All payments made by you under this Fee Letter must be made in immediately available, freely transferable and cleared funds by crediting the following bank account</p></div>
    <div class='flex flex-col mt-2'>
    <p class='ml-10'>Account Bank: ${data.bankDetails.accountBank}</p>
    <p class='ml-10'>Account Holder: ${data.bankDetails.accountHolder}</p>
    <p class='ml-10'>Account No.: ${data.bankDetails.accountNumber}</p>
    <p class='ml-10'>Sort Code: ${data.bankDetails.sortCode}</p>
    <p class='ml-10'>IBAN: ${data.bankDetails.iban}</p>
    <p class='ml-10'>Ref: ${data.borrowerName}-${data.currency} ${data.amount} ${data.facilityType} Facility Agreement\nor such other account as we manotify you in writing with {[${data.businessDays}]} *{Business Days}* prior notice.</p></div></div>\n`;
  } else {
    output += `<div class='flex ml-6'><p class='w-5 mr-2'>7.</p>A11 payments made by you under this Fee Letter must be made in immediately available, freely transferable and cleared funds by crediting our account (the details of which we have provided you with separately) or such other account as we may notify you in writing with {[${data.businessDays}]} *{Business Days'}*' prior notice.</div>\n`;
  }
  ...
  if (data.letterType === 'facilityAgent' || data.letterType === 'securityAgent') {
    output += `<div class='flex ml-6'><p class='w-5 mr-2'>10.</p>The ${
  ...
  // Miscellaneous
  output += `<div class='flex ml-6'><p class='w-5 mr-2'>11.</p>This Fee Letter and your rights hereunder may not be assigned by you without our prior written consent.</div>\n`;
  ...
  output += `<div class='flex ml-6'><p class='w-5 mr-2'>12.</p>This ${agentName} Fee Letter may not be amended or waived except as may be agreed in writing by the ${agentName} and the Borrower.</div>\n`;

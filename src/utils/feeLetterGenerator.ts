...
export const generateFeeLetterText = (data: IFeeLetterData) => {
  ...
  // Introduction
  output += `<div class="numbered-item"><p >1.</p>We refer to the Facility Agreement.</div>\n`;
  output += `<div class="numbered-item"><p >2.</p>Unless otherwise defined in this Fee Letter, terms defined in the Facility Agreement shall have the same meaning in this Fee Letter. The rules of interpretation and construction contained in clause *{ [1.2] (Construction)}* of the Facility Agreement shall apply to this Fee Letter as if set out in full in this Fee Letter mutatis mutandis, and references in those clauses to "this Agreement" or the *{Finance Documents}* shall be construed as references to this Fee Letter.</div>\n`;

  // Specific introduction based on letter type
  switch (data.letterType) {
    case 'facilityAgent':
      output += `<div class="numbered-item"><p >3. </p>This Letter is the Facility Agent Fee Letter.</div>\n`;
      break;
    case 'securityAgent':
      output += `<div class="numbered-item"><p >3. </p>This Letter is the Security Agent Fee Letter.</div>\n`;
      break;
    case 'globalCoordinator':
      output += `<div class="numbered-item"><p >3. </p>This Letter is the Global Co-Ordinator Fee Letter.</div>\n`;
      break;
    case 'coordinatingBank':
      output += `<div class="numbered-item"><p >3. </p>This Letter is the Co-Ordinating Bank Fee Letter.</div>\n`;
      break;
    case 'upfront':
      output += `<div class="numbered-item"><p >3. </p>This Letter is the Upfront Fee Letter.</div>\n`;
      break;
    case 'mandatedLeadArranger':
      output += `<div class="numbered-item"><p >3. </p>This Letter is the Mandated Lead Arranger Fee Letter.</div>\n`;
      break;
    case 'arranger':
      output += `<div class="numbered-item"><p >3. </p>This Letter is the Arranger Fee Letter.</div>\n`;
      break;
    default:
      output += `<div class="numbered-item"><p >3. </p>This Letter is the Facility Agent Fee Letter.</div>\n`;
  }
  ...
  output += `<div class="numbered-item"><p >4. </p>This ${getLetterTitle()
    .replace(/\(|\)/g, '')
    .toLowerCase()
    .split(' ')
  ...
  if (data.bankDetails.accountBank || data.bankDetails.accountNumber) {
    output += `<div class='flex flex-col'><div class="numbered-item"><p>7.</p>All payments made by you under this Fee Letter must be made in immediately available, freely transferable and cleared funds by crediting the following bank account</p></div>
    ...
    output += `<div class="numbered-item"><p >7.</p>A11 payments made by you under this Fee Letter must be made in immediately available, freely transferable and cleared funds by crediting our account (the details of which we have provided you with separately) or such other account as we may notify you in writing with {[${data.businessDays}]} *{Business Days'}*' prior notice.</div>\n`;
  }
  ...
  if (data.grossUpProvision === 'Standalone') {
    output += `<div class="numbered-item"><p >8.</p>If any *{Tax}* or amount in respect of a *{Tax}* must be deducted or withheld from any amount payable or paid by the ${data.borrowerName} on account of or by reference to any payment by or obligation of the ${data.borrowerName} hereunder, the ${data.borrowerName} shall pay such additional amounts as may be necessary to ensure that the recipient of such payment receives a net amount equal to the full amount which we would have received from the ${data.borrowerName} had such *{Tax}* not been made.</div>\n`;
  } else {
    output += `<div class="numbered-item"><p >8.</p>Clause *{ {12} (Tax Gross Up and Indemnities)}* of the Facility Agreement shall apply to this letter as if set out in full in this letter, mutatis mutandis, and references in that clause to Finance Documents shall be construed as including this Fee Letter.</div>\n`;
  }

  //For VAT Provision
  if (data.vatProvision === 'Standalone') {
    output += `<div class="numbered-item"><p >9. </p><p>All payments in connection with this Fee Letter are exclusive of any value added tax or similar charge ("<b>VAT</b>"). If VAT is chargeable, the ${data.borrowerName} shall also and at the same time pay to the recipient of the relevant payment an amount equal to the amount of the VAT.</p></div>\n`;
  } else {
    output += `<div class="numbered-item"><p>9. </p>Clause *{ {¢} (VAT)}* of the Facility Agreement shall apply to this letter as if set out in full in this letter, mutatis mutandis, and references in that clause to Finance Documents shall be construed as including this Fee Letter.</div>\n`;
  }

  // Fee refunds - only for facility agent and security agent
  if (data.letterType === 'facilityAgent' || data.letterType === 'securityAgent') {
    output += `<div class="numbered-item"><p>10.</p>The ${
  ...
  // Miscellaneous
  output += `<div class="numbered-item"><p >11.</p>This Fee Letter and your rights hereunder may not be assigned by you without our prior written consent.</div>\n`;
  ...
  output += `<div class="numbered-item"><p >12.</p>This ${agentName} Fee Letter may not be amended or waived except as may be agreed in writing by the ${agentName} and the Borrower.</div>\n`;
  output += `<div class="numbered-item"><p >13.</p>This ${agentName} Fee Letter may be signed in any number of counterparts. This has the same effect as if the signatures on the counterparts were on a single copy of this Fee Letter.</div>\n`;
  output += `<div class="numbered-item"><p >14.</p>A person who is not a party to this Fee Letter shall have no rights under the Contracts (Rights of Third Parties) Act 1999 or otherwise to enforce or enjoy the benefit of any terms of this Fee Letter.</div>\n`;
  output += `<div class="numbered-item"><p >15.</p>This letter and all non-contractual obligations arising from or connected with it are governed by ${data.governingLaw} law.</div>\n`;

  //For Jurisdiction Provision
  if (data.jurisdictionProvision === 'Standalone') {
    output += `<div class="numbered-item"><p >16.</p>Each party hereby submits to exclusive jurisdiction of the ${data.governingLaw} courts and waives any defence of forum non conveniens which may be available.</div>\n`;
  } else {
    output += `<div class="numbered-item"><p >16.</p>Clause {¢} (Enforcement) of the Facility Agreement shall apply to this Fee Letter as if set out in full in this Fee Letter mutatis mutandis, and references in those clauses to "this Agreement" or the Finance Documents shall be construed as references to this Fee Letter.</div>\n`;
  }
  ...
  output += `<div><p>For and on behalf of \n</p><p><b>${data.borrowerName}</b></p></div>\n`;
